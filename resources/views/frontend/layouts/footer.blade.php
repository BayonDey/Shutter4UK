                    ...
                    <div class="col-12 align-self-center">
                        <div class="newsletter">
                            ...
                            <div class="block">
                                ...
                                <form class="form-inline mailchimp-form"
                                    action="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/subscribeMail">
                                    <div class="search-field-module">
                                        <div class="search-field-wrap">
                                            <input type="email" name="email" class="email"
                                                placeholder="Your email address here..." data-toggle="tooltip"
                                                data-placement="bottom" title=""
                                                data-original-title="Your email address here...">
                                            <button class="btn btn-secondary swipe-to-top mailchimp-btn" type="submit"
        ...
        <div class="row">
            <div class="col-12 col-lg-3">
                <div class="single-footer">
                    ...
                    <ul class="contact-list  pl-0 mb-0">
                        ...
                        <li> <i class="fas fa-phone"></i><span dir="ltr">(+12 123 456789)</span> </li>
                        <li> <i class="fas fa-envelope"></i><span> <a
                                    href="mailto:contact@your-site.com">contact@your-site.com</a> </span> </li>
                ...
                <div class="footer-block">
                    <div class="single-footer single-footer-left">
                        ...
                        <ul class="links-list pl-0 mb-0">
                            <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public"><i
                                        class="fa fa-angle-right"></i>Home</a> </li>
                            <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/shop"><i
                                        class="fa fa-angle-right"></i>Shop</a> </li>
                            <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/orders"><i
                                        class="fa fa-angle-right"></i>Orders</a> </li>
                            <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/viewcart"><i
                                        class="fa fa-angle-right"></i>Shopping Cart</a> </li>
                            <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/wishlist"><i
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="single-footer single-footer-right">
                    ...
                    <ul class="links-list pl-0 mb-0">
                        <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=about-us"><i
                                    class="fa fa-angle-right"></i>About Us</a> </li>
                        <li> <a
                                href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=privacy-policy"><i
                                    class="fa fa-angle-right"></i>Privacy Policy</a> </li>
                        <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=refund-policy"><i
                                    class="fa fa-angle-right"></i>Refund Policy</a> </li>
                        <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=term-services"><i
                                    class="fa fa-angle-right"></i>Term &amp; Services</a> </li>
                        <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/contact"><i
                ...
                <div class="single-footer">
                    <div class="socials">
                        ...
                        <div class="footer-image">
                            <img class="img-fluid"
                                src="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/web/images/miscellaneous/payments.png">
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="footer-info">
                            © 2021 Company, Inc. <a
                                href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=refund-policy">Privacy</a>&nbsp;&bull;&nbsp;<a
                                href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=term-services">Terms</a>
                        </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-footer">
                        ...
                        <ul class="contact-list  pl-0 mb-0">
                            ...
                            <li> <i class="fas fa-phone"></i><span dir="ltr">(+12 123 456789)</span> </li>
                            <li> <i class="fas fa-envelope"></i><span> <a
                                        href="mailto:sales@brandbychoice.com">contact@your-site.com</a> </span> </li>
                        ...
                        <ul class="links-list pl-0 mb-0">
                            ...
                            <li> <a
                                    href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=privacy-policy"><i
                                        class="fa fa-angle-right"></i>Privacy Policy</a> </li>
                            <li> <a
                                    href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=refund-policy"><i
                                        class="fa fa-angle-right"></i>Refund Policy</a> </li>
                            <li> <a
                                    href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=term-services"><i
                                        class="fa fa-angle-right"></i>Term &amp; Services</a> </li>
                            <li> <a href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/contact"><i
                                        class="fa fa-angle-right"></i>Contact Us</a> </li>
                        </ul>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-8 col-lg-9">
                <div class="pro-description">
                    ...
                    Review our <a target="_blank"
                        href="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/page?name=cookies"
                        class="btn-link">cookies information</a>
...
<script src="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/web/js/jquery.instagramFeed.min.js"></script>
<script src="https://www.mydevfactory.com/~rezaul/rabiul/blink/public/web/js/scripts.js"></script>
<script>
    /////////////////// default code ///////////////////
    ...
    jQuery(".mailchimp-form").submit(function(e) {
        ...
        jQuery.ajax({
            ...
            type: "GET",
            url: "https://www.mydevfactory.com/~rezaul/rabiul/blink/public/subscribeMail",
    ...
    jQuery(document).on('click', '#allow-cookies', function(e) {
        jQuery.ajax({
            ...
            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/setcookie',
            type: "get",
            success: function(res) {
    ...
    jQuery(document).on('click', '.cart', function(e) {
        ...
        jQuery(function($) {
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/addToCart',
                headers: {
                    'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                },
                ...
                success: function(res) {
                    if (res.status == 'exceed') {
                        ...
                        jQuery.ajax({
                            ...
                            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/addToCartFixed',
                            headers: {
                                'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                            },
                        ...
                        jQuery.ajax({
                            ...
                            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/addToCartResponsive',
                            headers: {
                                'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                            },
    ...
    jQuery("#idForm").submit(function(e) {
        ...
        if (reviews_text != '') {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                url: "https://www.mydevfactory.com/~rezaul/rabiul/blink/public/reviews",
                data: form.serialize(), // serializes the form's elements.
                success: function(data) {
                    if (data == 'done') {
    ...
    jQuery(document).on('submit', '#apply_coupon', function(e) {
        ...
        if (jQuery('#coupon_code').val().length > 0) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/apply_coupon',
                type: "POST",
                data: formData,
                success: function(res) {
                    var obj = JSON.parse(res);
    ...
    function paymentMethods() {
        ...
        if (payment_method == 'instamojo' && currency_code != 'INR') {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/paymentComponent',
                type: "POST",
            ...
            if (payment_method == 'midtrans') {
                ...
                jQuery.ajax({
                    ...
                    url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/midtrans/transaction',
                    type: "get",
                    success: function(res) {
                        jQuery('#loader').hide();
                        jQuery('#payment_error').hide();
    ...
    jQuery(document).on('click', '#paystack_button', function(e) {
        ...
        jQuery.ajax({
            ...
            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/paystack/transaction',
            type: "get",
            success: function(res) {
                jQuery('#loader').hide();
                jQuery('#payment_error').hide();
    ...
    if (typeof resposne !== "undefined") {
        if (resposne.trim() == 'success') {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/checkout/payment/changeresponsestatus',
                type: "POST",
                async: false,
                success: function(res) {},
            });
    ...
    jQuery(document).on('click', '#pay_instamojo', function(e) {
        ...
        jQuery.ajax({
            ...
            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/pay-instamojo',
            type: "POST",
            data: formData,
            success: function(res) {
                var data = JSON.parse(res);
    ...
    function getZones() {
        jQuery(function($) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/ajaxZones',
                type: "POST",
...
<script type="application/javascript">
    OneSignal.push(function() {
        ...
        OneSignal.getUserId(function(userId) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/setSession',
                type: "get",
    ...
    jQuery(document).ready(function() {
                ...
                if (isSubscribed) {
                    OneSignal.getUserId(function(userId) {
                        ...
                        jQuery.ajax({
                            ...
                            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/subscribeNotification',
                            type: "POST",
        ...
        jQuery(document).on('click', '#stripe_ajax', function(e) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/stripeForm',
                type: "POST",
                success: function(res) {
        ...
        jQuery(document).on('click', '.modal_show', function(e) {
            ...
            jQuery(function($) {
                jQuery.ajax({
                    url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/modal_show',
                    headers: {
                        'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                    },
        ...
        jQuery(document).on('focusout', '#order_comments', function(e) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/commentsOrder',
                type: "POST",
        ...
        jQuery(document).on('click', '.is_liked', function(e) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/likeMyProduct',
                type: "POST",
                data: {
                ...
                success: function(res) {
                    ...
                    if (obj.success == 0) {} else if (obj.success == 2) {
            ...
            if (value > max || value < 1) {
                ...
                jQuery.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (url.trim() == 'true') {
                            window.location.href = 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/checkout';
                        } else {
                            if (res == 'exceed') {
        ...
        jQuery(document).on('click', '.update-single-Cart', function(e) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/updatesinglecart',
                type: "POST",
                data: formData,
                ...
                success: function(res) {
                    ...
                    if (url.trim() == 'true') {
                        ...
                        jQuery('#loader').css('display', 'none');
                        //window.location.href = 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/viewcart';
                        //message = "Product is added!";
                        //notification(message);
                    }
                    jQuery('#loader').hide();
        ...
        jQuery(document).on('click', '.default_address', function(e) {
            ...
            jQuery.ajax({
                ...
                url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/myDefaultAddress',
                type: "POST",
    ...
    function delete_cart_product(cart_id) {
        ...
        jQuery.ajax({
            ...
            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/deleteCart',
            type: "GET",
    ...
    function getQuantity() {
        ...
        jQuery.ajax({
            ...
            url: 'https://www.mydevfactory.com/~rezaul/rabiul/blink/public/getquantity',
            type: "POST",
            data: formData,
            dataType: "json",
            success: function(res) {
