                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary p-3">
                        <div class="card-body table-responsive p-2">
                            ...
                            <div class="col-md-12">
                                <a href="{{route('assign_express_delivery')}}" class="btn btn-success">Assign express delivery »</a>
                            </div>
                            @endif
                            ...
                            <table id="example1" class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr id="TR__{{$rowData->id }}">
                                        ...
                                        @if (App\Model\UserPermission::checkPermission('assign_express_delivery', 'edit') > 0)
                                        <td>
                                            <a href="{{route('express_delivery_edit', $rowData->id)}}"><i class="fa fa-edit"></i></a>
                                        </td>
                                        @endif
                                        @if (App\Model\UserPermission::checkPermission('assign_express_delivery', 'delete') > 0)
                                        <td>
                    ...
                    buttons: {
                        tryAgain: {
                            ...
                            action: function() {
                                $.ajax({
                                    type: 'POST',
                                    url: base_url + '/assign_express_delivery_delete',
                                    data: {
                                        _token: "<?= csrf_token(); ?>",
                                        ids: val,
                                    },
                                    success: function(data) {
                                        window.location = base_url + "/express-delivery/list";
                                    }
                                });
                            }
                        },
