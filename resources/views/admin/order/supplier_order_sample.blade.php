        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-10">
                            <h3>Supplier Sample Orders: {{ $status }}</h3>
                        </div>
                        <div class="col-sm-2">
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-primary p-3">
                        <form action="{{ route('updateOrderStatus_multiple') }}" id="order_list_form" method="post">
                            @csrf()
                            <p class="sample-title">Supplier sample order types:</p>
                            <div class="sample-active mb-4">
                                @if(count($suppliers) > 0)
                                @foreach($suppliers as $supplierRow)
                                <div class="btn btn-default ">
                                    <p>{{$supplierRow->supplier_name}}</p>
                                    <a class="btn btn-default btn-sm" href="{{route('supplier_order_sample', ['st'=>'Incomplete','supplierId'=> $supplierRow->supplier_id])}}">
                                        @if(($supplierId == $supplierRow->supplier_id) && ($status == 'Incomplete'))
                                        <i class="fa fa-check-circle"></i>
                                        @endif
                                        Pending
                                    </a>
                                    <a class="btn btn-default btn-sm" href="{{route('supplier_order_sample', ['st'=>'Complete','supplierId'=> $supplierRow->supplier_id])}}">
                                        @if(($supplierId == $supplierRow->supplier_id) && ($status == 'Complete'))
                                        <i class="fa fa-check-circle"></i>
                                        @endif
                                        Complete
                                    </a>
                            ...
                            <div class="optionFilter">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            <div class="col-8">
                                                <input type="hidden" name="page" value="supplier_sample">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <button type="button" class="generate_pdf btn btn-warning" style="margin: auto;display: block;margin-top: 2px;" disabled>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        @if($status != 'Cancelled')
                                                        <a class="dropdown-item" href="{{ route('updateOrderCancel', ['id'=>$order->id, 'page' => 'supplier_sample', 'supplierId' => $supplierId]) }}" onclick="return confirm('Are you sure you want to cancel order #<?= $order->id ?>?')">
                                                            Cancel
                                                        </a>
                                                        @endif

                                                        <a class="dropdown-item" href="{{ route('orderDeleteAndRestore', ['id'=>$order->id, 'page' => 'supplier_sample', 'supplierId' => $supplierId]) }}" onclick="return confirm('Are you sure you want to delete order #<?= $order->id ?>?')">
                                                            Delete
                                                        </a>
                            ...
                            <div class="col-md-12 row">
                                <div class="col-md-7">
                                    <!-- <span class="generate_pdf btn btn-warning"><i class="fa fa-file-download"></i> Download PDF</span> -->
                                </div>
